...
int main() {
  ...
  size_t dlugosc_nowego_napisu = strlen(nowy_napis);
  std::cout << "Długość nowego napisu: " << dlugosc_nowego_napisu << std::endl;
  ...
  std::cout << "Długość nowego napisu (wersja 2): " << strlen(napis3) << std::endl;
